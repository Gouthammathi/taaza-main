        ...
        <div className="flex items-end justify-between mt-2">
          <div className="flex flex-col items-start">
            {product.pricePerKg && Number(product.pricePerKg) > 0 ? (
              <span className="text-red-700 font-bold text-base leading-tight">₹{product.pricePerKg} <span className='text-xs text-gray-500'>/kg</span></span>
            ) : (
              <span className="text-red-700 font-bold text-base leading-tight">₹{product.price}</span>
            )}
          </div>
